/* B mód: a betű a zászló mellett, közel zászló-magasságban */
...
(async()=>{
  const chrome = spawn("/Applications/Google Chrome.app/Contents/MacOS/Google Chrome",[
    ...
    "--user-data-dir=/tmp/chrome-b2-"+Date.now()
  ],{stdio:"ignore"});
  let cel=null;
  ...
  /* a betű mérete: canvason a 2D réteg */
  const adat = await ev("(function(){var c=cB;return c.width+'x'+c.height;})()");
  console.log("cB:", JSON.stringify(adat.val));
  console.log("kesz");
